...
const EXAMPLE_PROMPTS = [
  "Add a luxury hot tub to this space",
  "Install a modern spa with water features",
  "Create a relaxing hot tub area",
  "Add a jacuzzi with ambient lighting",
  "Transform this into a spa retreat",
  "Install a hot tub with privacy screens"
];

const HotTubWizard: React.FC = () => {
  ...
  const handleApplyEdit = async () => {
    ...
    try {
      console.log('🛁 Starting hot tub addition...');
      
      // 1. Upload the image (like ColorTouch)
      const filename = `hottub_${Date.now()}.jpg`;
      ...
      console.log('✅ Hot tub addition complete:', resultUrl);

      // 3. Save to gallery (upload result to storage)
      const { data: { user } } = await supabase.auth.getUser();
      if (user) {
        // Upload the result image to storage
        const resultFilename = `hottub_result_${Date.now()}.jpg`;
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.container}>
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Your hot tub has been added</Text>
          </View>
          ...
          <View style={styles.footer}>
            ...
            >
              <Text style={styles.primaryButtonText}>🔄 Add Another Feature</Text>
            </TouchableOpacity>
          </View>
        </View>
      </SafeAreaView>
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        {/* Header */}
        <View style={styles.header}>
          <Text style={styles.title}>Can I Get a Hot Tub?</Text>
          <Text style={styles.subtitle}>Add luxury features to your space</Text>
        </View>
        ...
        <ScrollView style={styles.scrollContent} contentContainerStyle={styles.scrollContentContainer}>
          ...
          {photoUri && (
            <View style={styles.promptSection}>
              <Text style={styles.sectionLabel}>Describe the luxury feature you want...</Text>
              ...
              <View style={styles.promptCard}>
                <TextInput
                  ...
                  placeholder="Add a luxury hot tub to this space..."
          ...
          >
            {isProcessing ? (
              <View style={styles.loadingContainer}>
                ...
                <Text style={styles.applyButtonText}>Adding hot tub...</Text>
              </View>
            ) : (
              <View style={styles.applyButtonContent}>
                <Text style={styles.applyButtonIcon}>✨</Text>
                <Text style={styles.applyButtonText}>
                  {photoUri && prompt.trim() ? 'Add Hot Tub' : 'Upload photo and enter prompt'}
                </Text>
              </View>
            )}
          </TouchableOpacity>
