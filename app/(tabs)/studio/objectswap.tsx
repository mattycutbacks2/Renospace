...
const EXAMPLE_PROMPTS = [
  "Replace the old couch with a modern leather sofa",
  "Swap the coffee table for a glass top table",
  "Change the dining chairs to upholstered ones",
  "Replace the TV stand with a wall-mounted unit",
  "Swap the bedside table for a floating shelf",
  "Change the office chair to an ergonomic one"
];

const ObjectSwapWizard: React.FC = () => {
  ...
  const handleApplyEdit = async () => {
    ...
    try {
      console.log('🔄 Starting object swap...');
      
      // 1. Upload the image (like ColorTouch)
      const filename = `objectswap_${Date.now()}.jpg`;
      ...
      console.log('📥 Response received in UI:', data);
      ...
      console.log('✅ Object swap complete:', imageUrl);

      // 3. Save to gallery (upload result to storage)
      const { data: { user } } = await supabase.auth.getUser();
      if (user) {
        // Upload the result image to storage
        const resultFilename = `objectswap_result_${Date.now()}.jpg`;
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.container}>
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Your objects have been swapped</Text>
          </View>
          ...
          <View style={styles.footer}>
            ...
            >
              <Text style={styles.primaryButtonText}>🔄 Swap More Objects</Text>
            </TouchableOpacity>
          </View>
        </View>
      </SafeAreaView>
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        {/* Header */}
        <View style={styles.header}>
          <Text style={styles.title}>Object Swap</Text>
          <Text style={styles.subtitle}>Replace furniture and decor items seamlessly</Text>
        </View>
        ...
        <ScrollView style={styles.scrollContent} contentContainerStyle={styles.scrollContentContainer}>
          ...
          {photoUri && (
            <View style={styles.promptSection}>
              <Text style={styles.sectionLabel}>Describe what you'd like to swap...</Text>
              ...
              <View style={styles.promptCard}>
                <TextInput
                  ...
                  placeholder="Replace the old couch with a modern leather sofa..."
          ...
          >
            {isProcessing ? (
              <View style={styles.loadingContainer}>
                ...
                <Text style={styles.applyButtonText}>Swapping objects...</Text>
              </View>
            ) : (
              <View style={styles.applyButtonContent}>
                <Text style={styles.applyButtonIcon}>✨</Text>
                <Text style={styles.applyButtonText}>
                  {photoUri && prompt.trim() ? 'Swap Objects' : 'Upload photo and enter prompt'}
                </Text>
              </View>
            )}
          </TouchableOpacity>
...
export default ObjectSwapWizard; 