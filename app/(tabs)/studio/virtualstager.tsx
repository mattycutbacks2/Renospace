...
const EXAMPLE_PROMPTS = [
  "Stage this room for a modern family home",
  "Create a neutral staging for real estate",
  "Style this as a luxury apartment",
  "Stage for a young professional couple",
  "Design staging for a family with kids",
  "Create elegant staging for luxury buyers"
];

const VirtualStagerWizard: React.FC = () => {
  ...
  const handleApplyEdit = async () => {
    ...
    try {
      console.log('🏠 Starting virtual staging...');
      
      // 1. Upload the image (like ColorTouch)
      const filename = `virtualstager_${Date.now()}.jpg`;
      ...
      console.log('✅ Virtual staging complete:', resultUrl);

      // 3. Save to gallery (upload result to storage)
      const { data: { user } } = await supabase.auth.getUser();
      if (user) {
        // Upload the result image to storage
        const resultFilename = `virtualstager_result_${Date.now()}.jpg`;
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.container}>
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Your room has been staged</Text>
          </View>
          ...
          <View style={styles.footer}>
            ...
            >
              <Text style={styles.primaryButtonText}>🔄 Stage Another Room</Text>
            </TouchableOpacity>
          </View>
        </View>
      </SafeAreaView>
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        {/* Header */}
        <View style={styles.header}>
          <Text style={styles.title}>Virtual Stager</Text>
          <Text style={styles.subtitle}>Stage your home for sale or rental</Text>
        </View>
        ...
        <ScrollView style={styles.scrollContent} contentContainerStyle={styles.scrollContentContainer}>
          ...
          {photoUri && (
            <View style={styles.promptSection}>
              <Text style={styles.sectionLabel}>Describe the staging style you want...</Text>
              ...
              <View style={styles.promptCard}>
                <TextInput
                  ...
                  placeholder="Stage this room for a modern family home..."
          ...
          >
            {isProcessing ? (
              <View style={styles.loadingContainer}>
                ...
                <Text style={styles.applyButtonText}>Staging room...</Text>
              </View>
            ) : (
              <View style={styles.applyButtonContent}>
                <Text style={styles.applyButtonIcon}>✨</Text>
                <Text style={styles.applyButtonText}>
                  {photoUri && prompt.trim() ? 'Stage Room' : 'Upload photo and enter prompt'}
                </Text>
              </View>
            )}
          </TouchableOpacity>
...
export default VirtualStagerWizard; 